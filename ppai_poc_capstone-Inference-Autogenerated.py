...
model_name = "ppai_poc_capstone_model"
input_table_name = "ppai_poc_capstone.machine_predictive_maintenance.maintenance_hum"
output_table_path = "/FileStore/batch-inference/ppai_poc_capstone_model"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.ppai_poc_capstone_model"
...
output_df.filter(col("MACHINE_FAILURE")==col("prediction")).count()
